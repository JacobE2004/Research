...
file_path = r"c:\Users\Jmell\Dropbox\Research File - Copy\Nova_targets\LMCN_2012_10a\LMCN_2012_10a.dat"  # Raw string to handle backslashes
...
time = time - 2455260.60581   # Change this depending on tpeak
...
Ipeaky = [12.178, 12.178]  # Peak of novae
Ipeakyplus2 = [12.178 + 2, 12.178 + 2]  # When the nova drops below 2 mag
plt.plot(Ipeakx, Ipeaky, 'k--')
plt.plot(Ipeakx, Ipeakyplus2, 'k--')

tpeakx = [970.146, 970.146]  # Peak of nova days
tpeaky = [40, 5]  # Changes the where the dotted line starts and ends for y-axis
t2x = [982.6, 982.6]  # Days since peak where it drops below 2 mag last time
